...
export function InstallationStart() {
  ...
  document.title = "Старт установки";

  const getAllDateEventURL = `${installationId}/AllInstallationStart`;
  ...
  function changeInputCalendar() {
    ...
    const changeDateEventURL = `${installationId}/AddInstallationStart/${date}`;
  ...
  return (
    <div className="container">
      ...
      <p className="section-title">Старт установки:</p>
